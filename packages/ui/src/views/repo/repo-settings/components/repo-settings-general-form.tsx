...
export const RepoSettingsGeneralForm: React.FC<{
  ...
  repoData,
  isLoadingRepoData /*handleRepoUpdate, apiError, isLoadingRepoData, isUpdatingRepoData, isRepoUpdateSuccess*/
}) => {
  const {
    register,
    handleSubmit,
  ...
  if (isLoadingRepoData) {
    console.log('isLoadingRepoData o no here', isLoadingRepoData)
    return <SkeletonList />
  }

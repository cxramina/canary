  ...
  'group relative inline-flex items-center justify-center whitespace-nowrap px-3 py-1 text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 data-[state=active]:text-foreground-1',
  {
    variants: {
      variant: {
        ...
        navigation:
          'm-0 -mb-px h-[44px] border-b-[0.5px] border-solid border-b-transparent px-0 text-xs font-normal text-foreground-2 duration-150 ease-in-out hover:text-foreground-1 data-[state=active]:border-borders-9',
        tabnav:
